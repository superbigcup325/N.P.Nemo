...
| v0.6.0 | 2026-05-09 | **Bug修复 + 线性地图推进**：<br>✅ 修复 useEffect 依赖警告、currentRoom 同步、商店购买一致性<br>✅ 商店移除卡牌：添加牌组展示和选择交互<br>✅ 线性地图推进：只能进入下一个未完成房间<br>✅ 地图视觉优化：连线、DONE/NEXT/LOCKED 状态、GO 标签<br>✅ 楼层自动推进（_advance_floor） |
| v0.7.0 | 2026-05-10 | **阶段二/三完善 + 战斗动画**：<br>✅ 牌组浏览面板（DeckView：筛选/分类/升级标记）<br>✅ 战斗伤害飘字（敌人/玩家伤害数字上浮动画）<br>✅ 护甲获取动画（蓝色飘字）<br>✅ 卡牌入场动画（从下方滑入 + 逐张延迟）<br>✅ 清理调试代码（console.log 移除） |
